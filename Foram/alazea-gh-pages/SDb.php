...
<body>
    ...
    $emailCheck="select * from sellerregister where (email='$email');";
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        $sql = "INSERT INTO `sellerregister`(`name`, `number`, `email`, `city`, `pincode`, `password`) VALUES('$fullname', '$contactno','$email',  '$city', '$pincode', '$password')";
